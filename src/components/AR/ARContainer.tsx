  ...
  return (
    <div className="arDiv">
      <img
        alt="ape in ar"
        className="arImg"
        src="https://i.cbc.ca/1.5907934.1612914459!/fileImage/httpImage/image.jpg_gen/derivatives/16x9_940/saida-saetgar.jpg"
      />
      <IonButton className="arButtonMargin" onClick={openUnityThroughPlugin}>
        Open AR
      </IonButton>
      =======
      <div className="settingsContainer">
        <IonButton className="arButtonMargin" onClick={testPlugin}>
          Test Custom Plugin
        </IonButton>
        <IonButton className="arButtonMargin" onClick={openUnityThroughPlugin}>
          Open Unity
        ...
        <IonButton
          className="arButtonMargin"
          onClick={() => createNewObjectName(objectName)}
        >
        ...
        <IonButton className="arButtonMargin" onClick={alertARObject}>
